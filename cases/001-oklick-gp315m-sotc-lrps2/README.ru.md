...
| [`configs/xoutput/stick-mapping.notes.ru.md`](../../configs/xoutput/stick-mapping.notes.ru.md) | как мапить оси |
| [`scripts/`](../../scripts/) | запуск без Steam, CaptureSteps, PadTest |
| [`cheatsheets/oklick-gp315m.ru.md`](../../cheatsheets/oklick-gp315m.ru.md) | короткая шпаргалка |
